...
// Custom Undo button icon component for Quill editor. You can import 
// it directly from 'quill/assets/icons/undo.svg' but I found that 
// a number of loaders do not handle them correctly
const CustomUndo = () => (
...
function selectLocalImage() {
  ...
  input.onchange = async () => {
    ...
    if (/^image\//.test(file.type)) {
      ...
      // this.quill.current.editor.insertEmbed(range.index, 
      // "image", downloadURL);
      ...
      alert('You can insert only image!');
    }
  };
};
